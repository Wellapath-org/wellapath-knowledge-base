...
| `python3 testing/publication/test_publication.py` | 129 unit tests, including plan generation executed inside a guard that fails if a socket, a subprocess or a write outside the staging directory is attempted. |
